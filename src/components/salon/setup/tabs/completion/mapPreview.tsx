...
export default function MapPreview({locationLat,info,images,time,prices}:Props) {
...
function LeafletMap({ mapLocation,time,nameS,images,prices }: LeafletMapProps) {
                ...
                <Popup closeButton={false}>
                    ...
                    <div className=" w-[200px] h-fit flex flex-col  bg-light rounded-lg">
                        <div className="W-full relative flex items-center justify-center">
                            <div className={`absolute left-1 ${index === 0 ? "hidden":""}`}

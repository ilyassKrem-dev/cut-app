...
export default function SecondForm(
    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <Button className=" bg-green-1 text-black hover:bg-green-1 hover:opacity-60 transition-all duration-300" onClick={handleLogin} disabled={password.length <6 || loading || passwordConfiramtion.length ===0}>

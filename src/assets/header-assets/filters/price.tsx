        ...
        <div className="p-4 flex flex-col gap-5 bg-black/50 rounded-xl mx-3">
            ...
            <div className="flex gap-2 items-center justify-center px-2">
                <div className="w-full relative">
                    ...
                    <Input type="text" name="min" className=" h-16 pt-8 pb-3 pl-4 pr-10 focus-visible:ring-0 focus-visible:border-dark focus-visible:border-2 bg-black border-white/20 focus-visible:ring-offset-white/50 text-white/80" value={priceFilter.min as string} onChange={handleChange}/>
                ...
                <div className="w-full relative">
                    ...
                    <Input type="text" name="max" className=" h-16 pt-8 pb-3 pl-4 pr-10 focus-visible:ring-0 focus-visible:border-dark focus-visible:border-2 bg-black border-white/20 focus-visible:ring-offset-white/50 text-white/80" value={priceFilter.max as string} onChange={handleChange}/>
                    <p className="font-semibold text-sm absolute right-3 bottom-2 text-white/50">Dh</p>
                </div>
            </div>
        </div>

            ...
            <div className='flex flex-col gap-5'>
                ...
                <div className='flex items-center justify-center text-3xl gap-10'>
                    <div className='flex flex-col gap-1 items-center cursor-pointer group' onClick={() => handleClick("below")}>
                        <IoIosArrowBack className={`group-hover:bg-black/20 rounded-full p-1 transition-all duration-300 active:opacity-60 ${version == "below"&&"bg-black/20 rounded-full p-1"}`}/>
                    ...
                    <div className='flex flex-col gap-1 items-center group cursor-pointer' onClick={() => handleClick("same")}>
                        <RiEqualLine className={` group-hover:bg-black/20 rounded-full p-1 transition-all duration-300 active:opacity-60 ${version == "same"&&"bg-black/20 rounded-full p-1"}`}/>
                    ...
                    <div className='flex flex-col gap-1 items-center cursor-pointer group' onClick={() => handleClick("above")}>
                        <IoIosArrowBack  className={`rotate-180 group-hover:bg-black/20 rounded-full p-1 transition-all duration-300 active:opacity-60 ${version == "above"&&"bg-black/20 rounded-full p-1"}`}/>
